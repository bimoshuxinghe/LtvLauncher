            ...
            Expanded(
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    _StyleRadioTile(
                      title: localizations.clockStyleMinimal,
                      subtitle: localizations.clockStyleMinimalDesc,
                      value: 'minimal',
                    ...
                    _StyleRadioTile(
                      title: localizations.clockStyleBold,
                      subtitle: localizations.clockStyleBoldDesc,
                      value: 'bold',
                      groupValue: currentStyle,
                      onChanged: (value) => settingsService.setScreensaverClockStyle(value!),
                    ...
                    _StyleRadioTile(
                      title: localizations.clockStyleRetro,
                      subtitle: localizations.clockStyleRetroDesc,
                      value: 'retro',
                      groupValue: currentStyle,
                      onChanged: (value) => settingsService.setScreensaverClockStyle(value!),
                    ...
                    _StyleRadioTile(
                      title: localizations.clockStyleElegant,
                      subtitle: localizations.clockStyleElegantDesc,
                      value: 'elegant',
                      groupValue: currentStyle,
                      onChanged: (value) => settingsService.setScreensaverClockStyle(value!),
                    ...
                    _StyleRadioTile(
                      title: localizations.clockStyleNeon,
                      subtitle: localizations.clockStyleNeonDesc,
                      value: 'neon',
                      groupValue: currentStyle,
                      onChanged: (value) => settingsService.setScreensaverClockStyle(value!),
                    ...
                    _StyleRadioTile(
                      title: localizations.clockStylePixel,
                      subtitle: localizations.clockStylePixelDesc,
                      value: 'pixel',
                      groupValue: currentStyle,
                      onChanged: (value) => settingsService.setScreensaverClockStyle(value!),
                    ...
                    _StyleRadioTile(
                      title: localizations.clockStyleDigital,
                      subtitle: localizations.clockStyleDigitalDesc,
                      value: 'digital',
                      groupValue: currentStyle,
                      onChanged: (value) => settingsService.setScreensaverClockStyle(value!),
